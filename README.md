...
- Bootstrap v5 documentation was used for creating the carousel, cards and footer elements of the page. This involved copying over portions of bootstrap code and adjusting them to work within the site.
- A short amount of code was copied from stack overflow in order to adjust the width of the bootstrap containers for very large screens.